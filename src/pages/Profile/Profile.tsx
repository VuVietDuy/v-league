        ...
        <div className="col-span-12 md:col-span-7">
          <Card>
            ...
            >
                ...
                <Select className=" h-12 ">
                  {genders.map((gender, index) => (
                    <Select.Option key={index} value={gender.value}>
                      <div className="flex gap-4 items-center rounded-none">
              ...
              >
                <DatePicker placeholder="" className="w-full h-12" />
              </Form.Item>
              <Form.Item>
                <Button
                  type="primary"
                  className="flex w-full rounded-none justify-center items-center p-2 font-bold text-white h-[40px] mt-5 hover:opacity-85 hover:bg-purple-950 bg-purple-950"
                  htmlType="submit"
                  loading={loading}
                >
                  Cập nhật thông tin
        ...
        <div className="col-span-12 md:col-span-4">
          <Card>
            ...
            <button
              ...
              className="flex w-full justify-center items-center p-2 font-bold text-white h-[40px] mt-5 hover:opacity-85 bg-primary"
            >
              Đăng xuất
            </button>
          </Card>

...
export default function NewsDetail() {
  ...
  return (
    <div className="mb-20">
      ...
      >
        <div className="relative min-h-[120px] md:min-h-[195px] w-full overflow-hidden">
          <img
        ...
        <div className="absolute top-0 left-0 right-0 bottom-0 ">
          <div className="max-w-[888px] m-auto h-full py-5 flex flex-col justify-center">
            <span className="text-white text-lg font-bold mb-2">Tin tức</span>
            <h1 className="md:text-4xl text-white font-semibold mb-2">
              {news.title}
            </h1>
